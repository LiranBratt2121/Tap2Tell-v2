  ...
  return (
    <>
      ...
      <MetricsGrid>
        ...
        <DashboardMetricCard
          accent="#f56565"
          value={`${Math.round(metrics.averageActiveUserUsageTimeLast30Days)}m`}
          label="זמן שימוש חודשי ממוצע"
          description="זמן שימוש ממוצע למשתמש ב-30 הימים האחרונים -> סכום כל הזמנים היומיים של משתמשים פעילים ב-30 הימים האחרונים, חלקי מספר המשתמשים שהיו פעילים בתקופה זו"
        />

        <DashboardMetricCard
          accent="#f56565"
          value={`${Math.round(metrics.avergaeUsageTimeLast30DaysAllUsers)}m`}
          label="זמן שימוש חודשי ממוצע כל המשתמשים"
          description="זמן שימוש ממוצע למשתמש ב-30 הימים האחרונים -> סכום כל הזמנים היומיים של כל המשתמשים ב-30 הימים האחרונים, חלקי מספר כל המשתמשים באפליקציה"
        />
